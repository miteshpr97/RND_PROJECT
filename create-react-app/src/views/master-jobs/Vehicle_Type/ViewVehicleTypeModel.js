...
const ViewWorkOrderModal = ({ onClose }) => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await fetch(`${REACT_APP_API_URL}api/vehicle`);
        if (!response.ok) {
    ...
    >
      ...
      <DialogContent>
        <Table>
          <TableHead>
            <TableRow>
              <TableCell className='small-text'>Index no</TableCell>
              <TableCell className='small-text'>Vehicle Category</TableCell>
              <TableCell className='small-text'>Vehicle Type</TableCell>
          ...
          <TableBody>
            {displayedData.map((item, index) => (
              <TableRow key={index}>
                ...
                <TableCell className='small-text'>{item.vehicle_No}</TableCell>
                <TableCell className='small-text'>{item.vehicle_category}</TableCell>
                <TableCell className='small-text'>{item.vehicle_type}</TableCell>
